...
<input type="checkbox" <?php echo ($_REQUEST['category2_1']==1)?'checked="checked"':''; ?> class="B24checkbox_selector" name="category2_1" value="1">
Hotel<!--Label for search category 2 -->
</label>
</li>
<li class="B24checkbox">
<label class="B24checkbox_label">
<input type="checkbox" <?php echo ($_REQUEST['category2_2']==1)?'checked="checked"':''; ?> class="B24checkbox_selector" name="category2_2" value="1">
B&amp;B<!--Label for search category 2 -->
</label>
</li>
<li class="B24checkbox">
<label class="B24checkbox_label">
<input type="checkbox" <?php echo ($_REQUEST['category2_3']==1)?'checked="checked"':''; ?> class="B24checkbox_selector" name="category2_3" value="1">
